...
sub web_app_keyboard
{
	...
	my	$keyboard = [
		[
			...
			_button('Основное заболевание', 'preparation.html'),
		],
		[
			_button('Сопутствующие заболевания','preparation.html'),
			_button('Сопутствующие состояния', 'preparation.html'),
		],
		[
			_button('Лабораторные показатели', 'preparation.html', "\x{1F39B}"),
			_button('Лабораторные исследования', 'preparation.html', "\x{1F52C}"),
		],
